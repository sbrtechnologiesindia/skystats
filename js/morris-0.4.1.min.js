(function () {
    ...
    t = window.Morris = {}, e = jQuery, t.EventEmitter = function () {
        ...
        return n.prototype.defaults = {
            colors: ["#70a73f", "#eeeeee", "#679DC6", "#95BBD7", "#B0CCE1", "#095791", "#095085", "#083E67", "#052C48", "#042135"],
            ...
            this.text1 = this.drawEmptyDonutLabel(n, r - 10, this.options.labelColor, 25, 800), this.text2 = this.drawEmptyDonutLabel(n, r + 10, this.options.labelColor1, 11), u = Math.max.apply(null, function () {
                var e, t, n, r;
                n = this.data, r = [];
            ...
            var s;
            return s = this.raphael.text(e, t, "").attr("font-family", "'Montserrat',sans-serif").attr("font-size", r).attr("fill", n), i != null && s.attr("font-weight", i), s
        }, n
